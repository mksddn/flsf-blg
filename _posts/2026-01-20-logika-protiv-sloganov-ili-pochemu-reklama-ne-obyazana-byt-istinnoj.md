...
layout: post
description: Разберем известные слоганы на предмет их правдоподобности и определим,
  какого основания им не хватает для истинности. Найдем скрытую энтимему и допишем
  недостающую часть силлогизма.
permalink: "/:slug.html"
